...
def generate_orientations(trial,probe_x):
    ...
    if trial % 4 ==0:
        while np.unique(orientations).size != len(orientations) or abs(orientations[3]%180-orientations[2]%180)<20:
            ...
            sim_range1=random.randint((sim_step*0+1),(sim_step*1))
    ...
    if trial % 4 == 1:
        while np.unique(orientations).size != len(orientations) or abs(orientations[3]%180-orientations[2]%180)<20:
            ...
            sim_range1=random.randint((sim_step*1+1),(sim_step*2))
            sim_range2=random.randint((sim_step*0+1),(sim_step*1))
            if a==0:
                orientations[2]=(orientations[0]+sim_range1)
    ...
    if trial % 4 ==2:
        while np.unique(orientations).size != len(orientations) or abs(orientations[3]%180-orientations[2]%180)<20:
            ...
            orientations[1]=(random.randint(orientations[0]+20,orientations[0]-20+180))%180
            #orientations[1]=(orientations[0]+gabor_diff)%180
            sim_range1=-1*random.randint((sim_step*0+1),(sim_step*1))
    ...
    if trial % 4 == 3:
        while np.unique(orientations).size != len(orientations) or abs(orientations[3]%180-orientations[2]%180)<20:
            ...
            #orientations[1]=(orientations[0]+gabor_diff)%180
            sim_range1=-1*random.randint((sim_step*1+1),(sim_step*2))
            sim_range2=-1*random.randint((sim_step*0+1),(sim_step*1))
            if a==0:
                orientations[2]=(orientations[0]+sim_range1)
                orientations[3]=(orientations[1]+sim_range2)
                # while abs(orientations[3]%180-orientations[2]%180)<=20:
...
def generate_csv(filename, num_trials):
    ...
    for trial in range(num_trials):
        ...
        if trial % 3 == 0:
            ...
            if trial % 2 == 1:
                probe_x = right_x
                orientations,similarity,clockwise,sim_range1,sim_range2=generate_orientations(trial,probe_x)
