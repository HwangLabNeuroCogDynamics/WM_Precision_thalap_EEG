...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/xitchen/Library/CloudStorage/OneDrive-UniversityofIowa/circle_rotation_range2_local_thalap_EEG/circle_rotation_range2_local_750ms_lastrun.py',
...
for thisTrial in trials:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        if (trials.thisTrialN+1) % 40 == 0 and trials.thisTrialN > 0 and trials.thisTrialN != 119:
            continueRoutine = True
        else:
            continueRoutine = False
