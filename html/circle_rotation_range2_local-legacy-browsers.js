...
function instru_trialsLoopBegin(instru_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    instru_trials.forEach(function() {
...
function recap_instructionRoutineBegin(snapshot) {
  return async function () {
    ...
    recap_instructionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function distractorRoutineBegin(snapshot) {
  return async function () {
    ...
    distractorComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function impulseRoutineBegin(snapshot) {
  return async function () {
    ...
    impulseComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function end_training_feedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    end_training_feedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function main_sessionRoutineBegin(snapshot) {
  return async function () {
    ...
    main_sessionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function stimulus_mainRoutineBegin(snapshot) {
  return async function () {
    ...
    stimulus_mainComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function distractor_mainRoutineBegin(snapshot) {
  return async function () {
    ...
    distractor_mainComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function cue_mainRoutineBegin(snapshot) {
  return async function () {
    ...
    cue_mainComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function impulse_mainRoutineBegin(snapshot) {
  return async function () {
    ...
    impulse_mainComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
