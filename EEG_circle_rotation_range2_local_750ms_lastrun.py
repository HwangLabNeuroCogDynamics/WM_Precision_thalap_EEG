...
expName = 'circle_rotation_short_EEG'  # from the Builder filename that created this script
expInfo = {'participant': ''}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/xitchen/Desktop/WM_Precision_thalap_EEG/EEG_circle_rotation_range2_local_750ms_lastrun.py',
