...
expName = 'circle_rotation'  # from the Builder filename that created this script
expInfo = {'participant': ''}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/xitongchen/OneDrive - University of Iowa/circle_rotation_range2/circle_rotation_range2_lastrun.py',
...
# Initialize components for Routine "consent_instruct"
consent_instructClock = core.Clock()
consent_instr = visual.TextStim(win=win, name='consent_instr',
    text='Consent form will be shown. Press space to continue through each slide. Click Accept button to continue with experiment or do no accept to exit.',
    font='Arial',
...
consentimage1 = visual.ImageStim(
    win=win,
    name='consentimage1', 
    image='consent1_sona.png', mask=None,
...
consentimage2 = visual.ImageStim(
    win=win,
    name='consentimage2', 
    image='consent2_sona.png', mask=None,
    ori=0, pos=(0, 0), size=(1, 1),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=0.0)
...
consentimage_3 = visual.ImageStim(
    win=win,
    name='consentimage_3', 
    image='consent3_sona.png', mask=None,
    ori=0, pos=(0, 0.1), size=(1, 1),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=0.0)
accept_button = visual.ImageStim(
    ...
    ori=0, pos=(-0.45, -0.45), size=(0.1, 0.05),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=-1.0)
not_accept_button = visual.ImageStim(
    win=win,
    name='not_accept_button', 
    image='not_accept.png', mask=None,
    ori=0, pos=(0.45, -0.45), size=(0.1, 0.05),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=-2.0)
accept_mouse = event.Mouse(win=win)
x, y = [None, None]
accept_mouse.mouseClock = core.Clock()
...
instru4 = visual.ImageStim(
    win=win,
    name='instru4', 
    image='instruction4.png', mask=None,
    ori=0, pos=(0, 0), size=(1.65, 1),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=0.0)
...
instru5 = visual.ImageStim(
    win=win,
    name='instru5', 
    image='instruction5.png', mask=None,
    ori=0, pos=(0, 0), size=(1.65, 1),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=0.0)
...
instru6 = visual.ImageStim(
    win=win,
    name='instru6', 
    image='instruction6.png', mask=None,
    ori=0, pos=(0, 0), size=(1.65, 1),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=0.0)
...
instru7 = visual.ImageStim(
    win=win,
    name='instru7', 
    image='instruction7.png', mask=None,
    ori=0, pos=(0, 0), size=(1.63, 1),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=0.0)
instru7_resp = keyboard.Keyboard()
...
impulseClock = core.Clock()
left_impulse = visual.ImageStim(
    win=win,
    name='left_impulse', 
    image='impulse_probe.png', mask=None,
    ori=0, pos=(-0.25, 0), size=(0.25, 0.25),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=0.0)
central_impulse = visual.ImageStim(
    win=win,
    name='central_impulse', 
    image='impulse_probe.png', mask=None,
    ori=0, pos=(0, 0), size=(0.25, 0.25),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=-1.0)
right_impulse = visual.ImageStim(
    win=win,
    name='right_impulse', 
    image='impulse_probe.png', mask=None,
    ori=0, pos=(0.25, 0), size=(0.25, 0.25),
...
impulse_mainClock = core.Clock()
left_impulse_main = visual.ImageStim(
    win=win,
    name='left_impulse_main', 
    image='impulse_probe.png', mask=None,
    ori=0, pos=(-0.25, 0), size=(0.25, 0.25),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=0.0)
central_impulse_main = visual.ImageStim(
    win=win,
    name='central_impulse_main', 
    image='impulse_probe.png', mask=None,
    ori=0, pos=(0, 0), size=(0.25, 0.25),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=-1.0)
right_impulse_main = visual.ImageStim(
    win=win,
    name='right_impulse_main', 
    image='impulse_probe.png', mask=None,
    ori=0, pos=(0.25, 0), size=(0.25, 0.25),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=-2.0)
fix_cross4 = visual.TextStim(win=win, name='fix_cross4',
    text='+',
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
...
ending = visual.TextStim(win=win, name='ending',
    text='Congrats! You complete the whole experiment!\nWe will pay you extra bonuses based on your data quality.\nThank you for participating!',
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
# ------Prepare to start Routine "consent_instruct"-------
...
consent_instructComponents = [consent_instr, key_resp_6]
for thisComponent in consent_instructComponents:
...
consent_instructClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "consent_instruct"-------
while continueRoutine:
    # get current time
    t = consent_instructClock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=consent_instructClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
    
    # *consent_instr* updates
    if consent_instr.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        consent_instr.frameNStart = frameN  # exact frame index
        consent_instr.tStart = t  # local t and not account for scr refresh
        consent_instr.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(consent_instr, 'tStartRefresh')  # time at next scr refresh
        consent_instr.setAutoDraw(True)
...
# -------Ending Routine "consent_instruct"-------
for thisComponent in consent_instructComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
# the Routine "consent_instruct" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()
...
_key_resp_5_allKeys = []
# keep track of which components have finished
consent1Components = [consentimage1, key_resp_5]
...
while continueRoutine:
    ...
    # *consentimage1* updates
    if consentimage1.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        consentimage1.frameNStart = frameN  # exact frame index
        consentimage1.tStart = t  # local t and not account for scr refresh
        consentimage1.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(consentimage1, 'tStartRefresh')  # time at next scr refresh
        consentimage1.setAutoDraw(True)
...
_key_resp_8_allKeys = []
# keep track of which components have finished
consent2Components = [consentimage2, key_resp_8]
...
while continueRoutine:
    ...
    # *consentimage2* updates
    if consentimage2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        consentimage2.frameNStart = frameN  # exact frame index
        consentimage2.tStart = t  # local t and not account for scr refresh
        consentimage2.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(consentimage2, 'tStartRefresh')  # time at next scr refresh
        consentimage2.setAutoDraw(True)
...
continueRoutine = True
# update component parameters for each repeat
# setup some python lists for storing info about the accept_mouse
accept_mouse.clicked_name = []
gotValidClick = False  # until a click is received
# keep track of which components have finished
consent_3Components = [consentimage_3, accept_button, not_accept_button, accept_mouse]
...
while continueRoutine:
    ...
    # *consentimage_3* updates
    if consentimage_3.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        consentimage_3.frameNStart = frameN  # exact frame index
        consentimage_3.tStart = t  # local t and not account for scr refresh
        consentimage_3.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(consentimage_3, 'tStartRefresh')  # time at next scr refresh
        consentimage_3.setAutoDraw(True)
    
    # *accept_button* updates
    if accept_button.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
    ...
    # *not_accept_button* updates
    if not_accept_button.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        not_accept_button.frameNStart = frameN  # exact frame index
        not_accept_button.tStart = t  # local t and not account for scr refresh
        not_accept_button.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(not_accept_button, 'tStartRefresh')  # time at next scr refresh
        not_accept_button.setAutoDraw(True)
    # *accept_mouse* updates
    if accept_mouse.status == NOT_STARTED and t >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        accept_mouse.frameNStart = frameN  # exact frame index
        accept_mouse.tStart = t  # local t and not account for scr refresh
        accept_mouse.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(accept_mouse, 'tStartRefresh')  # time at next scr refresh
        accept_mouse.status = STARTED
        accept_mouse.mouseClock.reset()
        prevButtonState = accept_mouse.getPressed()  # if button is down already this ISN'T a new click
    if accept_mouse.status == STARTED:  # only update if started and not finished!
        buttons = accept_mouse.getPressed()
        if buttons != prevButtonState:  # button state changed?
            prevButtonState = buttons
            if sum(buttons) > 0:  # state changed to a new click
                # check if the mouse was inside our 'clickable' objects
                gotValidClick = False
                for obj in [accept_button, not_accept_button]:
                    if obj.contains(accept_mouse):
                        gotValidClick = True
                        accept_mouse.clicked_name.append(obj.name)
...
if accept_mouse.clicked_name[0] == 'not_accept_button':
    exit_text.setText('You did not accept the consent form. Press space to exit.')
    welcom_ins.opacity = 0.0
    
# keep track of which components have finished
welcomeComponents = [welcom_ins, welcome_resp, exit_text]
...
for thisInstru_trial in instru_trials:
    ...
    # keep track of which components have finished
    instruction7Components = [instru7, instru7_resp]
    ...
    while continueRoutine:
        ...
        # *instru7* updates
        if instru7.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            instru7.frameNStart = frameN  # exact frame index
            instru7.tStart = t  # local t and not account for scr refresh
            instru7.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(instru7, 'tStartRefresh')  # time at next scr refresh
            instru7.setAutoDraw(True)
        
        # *instru7_resp* updates
        waitOnFlip = False
        if instru7_resp.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            instru7_resp.frameNStart = frameN  # exact frame index
            instru7_resp.tStart = t  # local t and not account for scr refresh
            instru7_resp.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(instru7_resp, 'tStartRefresh')  # time at next scr refresh
            instru7_resp.status = STARTED
            # keyboard checking is just starting
            waitOnFlip = True
            win.callOnFlip(instru7_resp.clock.reset)  # t=0 on next screen flip
            win.callOnFlip(instru7_resp.clearEvents, eventType='keyboard')  # clear events on next screen flip
        if instru7_resp.status == STARTED and not waitOnFlip:
            theseKeys = instru7_resp.getKeys(keyList=['space'], waitRelease=False)
            _instru7_resp_allKeys.extend(theseKeys)
            if len(_instru7_resp_allKeys):
                instru7_resp.keys = _instru7_resp_allKeys[-1].name  # just the last key pressed
                instru7_resp.rt = _instru7_resp_allKeys[-1].rt
                # a response ends the routine
                continueRoutine = False
    ...
    for thisPractice in practice:
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            if left_gabor.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > left_gabor.tStartRefresh + 0.6-frameTolerance:
                    # keep track of stop time/frame for later
            ...
            if right_gabor.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > right_gabor.tStartRefresh + 0.6-frameTolerance:
                    # keep track of stop time/frame for later
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            if fixation2.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > fixation2.tStartRefresh + 1.2-frameTolerance:
                    # keep track of stop time/frame for later
            ...
            if left_distractor_prac.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > left_distractor_prac.tStartRefresh + 0.6-frameTolerance:
                    # keep track of stop time/frame for later
            ...
            if right_distractor_prac.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > right_distractor_prac.tStartRefresh + 0.6-frameTolerance:
                    # keep track of stop time/frame for later
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            if cue_text.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > cue_text.tStartRefresh + 0.5-frameTolerance:
                    # keep track of stop time/frame for later
        ...
        # update component parameters for each repeat
        # keep track of which components have finished
        impulseComponents = [left_impulse, central_impulse, right_impulse, fixation4]
        for thisComponent in impulseComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        t = 0
        _timeToFirstFrame = win.getFutureFlipTime(clock="now")
        impulseClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
        frameN = -1
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            tThisFlip = win.getFutureFlipTime(clock=impulseClock)
            tThisFlipGlobal = win.getFutureFlipTime(clock=None)
            frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
            # update/draw components on each frame
            
            # *left_impulse* updates
            if left_impulse.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                left_impulse.frameNStart = frameN  # exact frame index
                left_impulse.tStart = t  # local t and not account for scr refresh
                left_impulse.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(left_impulse, 'tStartRefresh')  # time at next scr refresh
                left_impulse.setAutoDraw(True)
            if left_impulse.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > left_impulse.tStartRefresh + 0.2-frameTolerance:
                    # keep track of stop time/frame for later
                    left_impulse.tStop = t  # not accounting for scr refresh
                    left_impulse.frameNStop = frameN  # exact frame index
                    win.timeOnFlip(left_impulse, 'tStopRefresh')  # time at next scr refresh
                    left_impulse.setAutoDraw(False)
            
            # *central_impulse* updates
            if central_impulse.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                central_impulse.frameNStart = frameN  # exact frame index
                central_impulse.tStart = t  # local t and not account for scr refresh
                central_impulse.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(central_impulse, 'tStartRefresh')  # time at next scr refresh
                central_impulse.setAutoDraw(True)
            if central_impulse.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > central_impulse.tStartRefresh + 0.2-frameTolerance:
                    # keep track of stop time/frame for later
                    central_impulse.tStop = t  # not accounting for scr refresh
                    central_impulse.frameNStop = frameN  # exact frame index
                    win.timeOnFlip(central_impulse, 'tStopRefresh')  # time at next scr refresh
                    central_impulse.setAutoDraw(False)
            
            # *right_impulse* updates
            if right_impulse.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                right_impulse.frameNStart = frameN  # exact frame index
                right_impulse.tStart = t  # local t and not account for scr refresh
                right_impulse.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(right_impulse, 'tStartRefresh')  # time at next scr refresh
                right_impulse.setAutoDraw(True)
            if right_impulse.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > right_impulse.tStartRefresh + 0.2-frameTolerance:
                    # keep track of stop time/frame for later
                    right_impulse.tStop = t  # not accounting for scr refresh
                    right_impulse.frameNStop = frameN  # exact frame index
                    win.timeOnFlip(right_impulse, 'tStopRefresh')  # time at next scr refresh
                    right_impulse.setAutoDraw(False)
            
            # *fixation4* updates
            if fixation4.status == NOT_STARTED and tThisFlip >= 0.2-frameTolerance:
                # keep track of start time/frame for later
            ...
            if fixation4.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > fixation4.tStartRefresh + 0.4-frameTolerance:
                    # keep track of stop time/frame for later
        ...
        for thisComponent in impulseComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        practice.addData('left_impulse.started', left_impulse.tStartRefresh)
        practice.addData('left_impulse.stopped', left_impulse.tStopRefresh)
        practice.addData('central_impulse.started', central_impulse.tStartRefresh)
        practice.addData('central_impulse.stopped', central_impulse.tStopRefresh)
        practice.addData('right_impulse.started', right_impulse.tStartRefresh)
        practice.addData('right_impulse.stopped', right_impulse.tStopRefresh)
        practice.addData('fixation4.started', fixation4.tStartRefresh)
        practice.addData('fixation4.stopped', fixation4.tStopRefresh)
        ...
        gotValidClick = False  # until a click is received
        # keep track of which components have finished
        responseComponents = [cue_resp, probe, probe_resp, mouse]
        ...
        while continueRoutine:
            ...
            if probe_resp.status == STARTED and not waitOnFlip:
                theseKeys = probe_resp.getKeys(keyList=['space'], waitRelease=False)
        ...
        practice.addData('probe_resp.keys',probe_resp.keys)
        if probe_resp.keys != None:  # we had a response
            practice.addData('probe_resp.rt', probe_resp.rt)
        if probe.ori > 180:
            probe.ori -= 180
...
for thisTrial in trials:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if fix_cross.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > fix_cross.tStartRefresh + 0.8-frameTolerance:
                # keep track of stop time/frame for later
        ...
        if left_target.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > left_target.tStartRefresh + 0.3-frameTolerance:
                # keep track of stop time/frame for later
        ...
        if right_target.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > right_target.tStartRefresh + 0.3-frameTolerance:
                # keep track of stop time/frame for later
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if fix_cross2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > fix_cross2.tStartRefresh + 0.5-frameTolerance:
                # keep track of stop time/frame for later
        ...
        if left_distractor_main.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > left_distractor_main.tStartRefresh + 0.3-frameTolerance:
                # keep track of stop time/frame for later
        ...
        if right_distractor_main.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > right_distractor_main.tStartRefresh + 0.3-frameTolerance:
                # keep track of stop time/frame for later
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if fix_cross3.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > fix_cross3.tStartRefresh + 0.9-frameTolerance:
                # keep track of stop time/frame for later
    ...
    # update component parameters for each repeat
    # keep track of which components have finished
    impulse_mainComponents = [left_impulse_main, central_impulse_main, right_impulse_main, fix_cross4]
    for thisComponent in impulse_mainComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    impulse_mainClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "impulse_main"-------
    while continueRoutine and routineTimer.getTime() > 0:
        # get current time
        t = impulse_mainClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=impulse_mainClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        
        # *left_impulse_main* updates
        if left_impulse_main.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            left_impulse_main.frameNStart = frameN  # exact frame index
            left_impulse_main.tStart = t  # local t and not account for scr refresh
            left_impulse_main.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(left_impulse_main, 'tStartRefresh')  # time at next scr refresh
            left_impulse_main.setAutoDraw(True)
        if left_impulse_main.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > left_impulse_main.tStartRefresh + 0.1-frameTolerance:
                # keep track of stop time/frame for later
                left_impulse_main.tStop = t  # not accounting for scr refresh
                left_impulse_main.frameNStop = frameN  # exact frame index
                win.timeOnFlip(left_impulse_main, 'tStopRefresh')  # time at next scr refresh
                left_impulse_main.setAutoDraw(False)
        
        # *central_impulse_main* updates
        if central_impulse_main.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            central_impulse_main.frameNStart = frameN  # exact frame index
            central_impulse_main.tStart = t  # local t and not account for scr refresh
            central_impulse_main.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(central_impulse_main, 'tStartRefresh')  # time at next scr refresh
            central_impulse_main.setAutoDraw(True)
        if central_impulse_main.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > central_impulse_main.tStartRefresh + 0.1-frameTolerance:
                # keep track of stop time/frame for later
                central_impulse_main.tStop = t  # not accounting for scr refresh
                central_impulse_main.frameNStop = frameN  # exact frame index
                win.timeOnFlip(central_impulse_main, 'tStopRefresh')  # time at next scr refresh
                central_impulse_main.setAutoDraw(False)
        
        # *right_impulse_main* updates
        if right_impulse_main.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            right_impulse_main.frameNStart = frameN  # exact frame index
            right_impulse_main.tStart = t  # local t and not account for scr refresh
            right_impulse_main.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(right_impulse_main, 'tStartRefresh')  # time at next scr refresh
            right_impulse_main.setAutoDraw(True)
        if right_impulse_main.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > right_impulse_main.tStartRefresh + 0.1-frameTolerance:
                # keep track of stop time/frame for later
                right_impulse_main.tStop = t  # not accounting for scr refresh
                right_impulse_main.frameNStop = frameN  # exact frame index
                win.timeOnFlip(right_impulse_main, 'tStopRefresh')  # time at next scr refresh
                right_impulse_main.setAutoDraw(False)
        
        # *fix_cross4* updates
        if fix_cross4.status == NOT_STARTED and tThisFlip >= 0.1-frameTolerance:
            # keep track of start time/frame for later
        ...
        if fix_cross4.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > fix_cross4.tStartRefresh + 0.4-frameTolerance:
                # keep track of stop time/frame for later
    ...
    for thisComponent in impulse_mainComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    trials.addData('left_impulse_main.started', left_impulse_main.tStartRefresh)
    trials.addData('left_impulse_main.stopped', left_impulse_main.tStopRefresh)
    trials.addData('central_impulse_main.started', central_impulse_main.tStartRefresh)
    trials.addData('central_impulse_main.stopped', central_impulse_main.tStopRefresh)
    trials.addData('right_impulse_main.started', right_impulse_main.tStartRefresh)
    trials.addData('right_impulse_main.stopped', right_impulse_main.tStopRefresh)
    trials.addData('fix_cross4.started', fix_cross4.tStartRefresh)
    trials.addData('fix_cross4.stopped', fix_cross4.tStopRefresh)
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        if (trials.thisTrialN+1) % 50 == 0 and trials.thisTrialN > 0 and trials.thisTrialN != 299:
            continueRoutine = True
        else:
            continueRoutine = False
